...
5. Call the Gemini adapter to extract structured data and
   confidences.
...
from ..llm.gemini_adapter import extract_Memos, generate_report
...
def process_Memos_file(Memos: Memos) -> None:
    """Process an uploaded Memos through the Gemini pipeline.
