...
class BaseConfig:
    ...
    VISION_MODEL_NAME = os.getenv("VISION_MODEL_NAME", "Qwen/Qwen2-VL-2B-Instruct")
    VISION_MODEL_DEVICE = os.getenv("VISION_MODEL_DEVICE", "auto")
    VISION_MODEL_MAX_NEW_TOKENS = int(os.getenv("VISION_MODEL_MAX_NEW_TOKENS", "2048"))
    VISION_MODEL_TEMPERATURE = float(os.getenv("VISION_MODEL_TEMPERATURE", "0.2"))
    MODEL_REQUEST_TIMEOUT = int(os.getenv("MODEL_REQUEST_TIMEOUT", "120"))
    MODEL_MAX_RETRIES = int(os.getenv("MODEL_MAX_RETRIES", "2"))
    MODEL_RETRY_BACKOFF_SECS = float(os.getenv("MODEL_RETRY_BACKOFF_SECS", "2"))
    ...
    REDACT_KEYS = _split(
        ...
        {"HUGGINGFACE_HUB_TOKEN", "WHATSAPP_ACCESS_TOKEN", "TWILIO_AUTH_TOKEN", "Authorization"},
    )
